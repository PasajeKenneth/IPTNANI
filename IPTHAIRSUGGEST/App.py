...
def make_prediction(data):
    try:
        ...
        print("Model prediction:", prediction)  # Log the prediction for debugging
...
def predict():
    ...
    # Log the inputs before prediction
    print("Face Shape:", data.get('face_shape'))
    print("Gender:", data.get('gender'))
    print("Age Group:", data.get('age_group'))
